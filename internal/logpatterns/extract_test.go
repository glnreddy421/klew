...
func TestRankTopFieldsTfIdfPromotesEmergingKeys(t *testing.T) {
	...
	out := logpatterns.Extract(ev, logpatterns.SnapshotInput{}, logpatterns.Options{MaxAttrs: 5})
...
func TestPatternIDStableAcrossWindows(t *testing.T) {
	...
	a := logpatterns.Extract(ev, logpatterns.SnapshotInput{}, logpatterns.Options{})
	b := logpatterns.Extract(ev, logpatterns.SnapshotInput{}, logpatterns.Options{})
...
func TestTokenizeWordsStripsDrainWildcards(t *testing.T) {
	...
	out := logpatterns.Extract(ev, logpatterns.SnapshotInput{}, logpatterns.Options{MaxWords: 20})
...
func TestMaxClustersBound(t *testing.T) {
	...
	out := logpatterns.Extract(ev, logpatterns.SnapshotInput{}, logpatterns.Options{MaxClusters: 16, MaxTemplates: 40})
